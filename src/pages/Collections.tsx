    ...
    <main className="bg-brand-primary min-h-screen pb-32 md:pb-0">
      ...
      <header className="pt-32 md:pt-40 pb-12 px-6 md:px-12 max-w-[1600px] mx-auto">
        ...
        >
          ...
          <h1 className="text-5xl md:text-8xl font-display font-black uppercase tracking-tighter leading-[0.85] mb-8 text-brand-secondary">
            Elite <span className="text-vibe-gradient italic">Collections</span>
          </h1>
        ...
        <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center justify-between md:justify-end gap-6 w-full md:w-auto">
             <div className="flex items-center gap-4 text-[10px] uppercase tracking-[0.2em] font-black text-brand-muted bg-brand-secondary/5 border border-brand-border/50 px-5 py-2.5 rounded-full group cursor-pointer hover:border-brand-accent-glow/50 transition-all">
                ...
                <select 
                  className="bg-transparent text-brand-secondary outline-none cursor-pointer font-black border-none focus:ring-0 p-0 text-[10px]"
                  value={sortBy}
      ...
      {/* Product Grid */}
      <section className="pt-8 pb-32 px-4 md:px-12 max-w-[1600px] mx-auto">
        <motion.div 
          layout
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-12 md:gap-x-8 md:gap-y-16"
        >
